...
class MainWindow(QtWidgets.QWidget):
    ...
    def initUI(self):
        ...
        self.eloggerEntry.setToolTip('<i>Enter GPS coordinates in eLogger format</i>')
        ...
        self.traditionalEntry.setToolTip('<i>Enter traditional GPS coordinates</i>')
        ...
        self.selectFileButton.setToolTip('<i>Select an Excel file to process</i>')
